...
_EXPORTS: ExportMap = {
    ...
    "DEFAULT_TEMPLATE_FEATURES": ("ia_analysis.orbits.template_orbits", "DEFAULT_TEMPLATE_FEATURES"),
    ...
    "read_pinocchio_table": ("ia_analysis.orbits.pinocchio", "read_pinocchio_table"),
    ...
    "ellipsoid_shape_coefficients": ("ia_analysis.orbits.ellipsoidal_model", "ellipsoid_shape_coefficients"),
    "homogeneous_ellipsoid_tidal_tensor": (
        "ia_analysis.orbits.ellipsoidal_model",
        "homogeneous_ellipsoid_tidal_tensor",
    ),
    "shape_tensor_from_axes": ("ia_analysis.orbits.ellipsoidal_model", "shape_tensor_from_axes"),
    ...
    "power_law_mass_fraction": ("ia_analysis.orbits.tidal_stripping", "power_law_mass_fraction"),
    ...
    "orbital_time_from_omega": ("ia_analysis.orbits.tidal_stripping", "orbital_time_from_omega"),
    "tidal_track_ratio": ("ia_analysis.orbits.tidal_stripping", "tidal_track_ratio"),
